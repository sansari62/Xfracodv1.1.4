    ...
    float& xe2, float& ye2)
{
    ...
    */
    ...
    db = sqrt(powf(xcross - xb1, 2) + powf(ycross - yb1, 2));
    de = sqrt(powf(xcross - xe1, 2) + powf(ycross - ye1, 2));
    if (db < de)
    {
        xe2 = xb1;
        ye2 = yb1;
...
//                dbeg = min(sqrt((xt - (2. * symm.xsym - xbeg)) * (xt - (2. * symm.xsym - xbeg)) +
//                    (yt - (2. * symm.ysym - ybeg)) * (yt - (2. * symm.ysym - ybeg))),
//                    sqrtf((xt0 - (2. * symm.xsym - xbeg)) * (xt0 - (2. * symm.xsym - xbeg)) +
//                        (yt0 - (2. * symm.ysym - ybeg)) * (yt0 - (2. * symm.ysym - ybeg))));
//
//                dend = min(sqrt((xt - (2. * symm.xsym - xend)) * (xt - (2. * symm.xsym - xend)) +
//                    (yt - (2. * symm.ysym - yend)) * (yt - (2. * symm.ysym - yend))),
...
////
////        float ss = (sigyy - sigxx) * sicosinb + sigxy * (cosb2 - sinb2);
////        float sn = sigxx * sinb2 - 2.0 * sigxy * sicosinb + sigyy * cosb2;
////        s4.b0[m * 2] = -ss;
////        s4.b0[m * 2 + 1] = -sn;
...
////    float pxy = symm.pxy1;
////     
////    b_elm[m].force1 = 2.0 * elm_list[m].a * (-((pyy - pxx) * sicosinb + pxy * (cosb2 - sinb2)));     //!old b0()
////    b_elm[m].force2 = 2.0 * elm_list[m].a * (-(pxx * sinb2 - 2.0 * pxy * sicosinb + pyy * cosb2));  // !old b0()
////
////    return;
////}
////
